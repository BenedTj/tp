...
public class TypicalDeliveries {
    ...
    public static final Delivery DELIVERY_BENSON = new DeliveryBuilder().withStartDate("2025-10-19")
    ...
    public static final Delivery DELIVERY_CARL = new DeliveryBuilder().withStartDate("2024-10-21")
    ...
    public static final Delivery DELIVERY_DANIEL = new DeliveryBuilder().withStartDate("2019-03-19")
            .withEndDate("2019-03-27").withDeliveryDays("Wednesday", "Friday")
            .withDeliveryTime("12:00")
            .withSkippedDates().build();
    public static final Delivery DELIVERY_ELLE = new DeliveryBuilder().withStartDate("2019-05-21")
    ...
    public static List<Delivery> getTypicalDeliveries() {
        return new ArrayList<>(Arrays.asList(DELIVERY_ALICE, DELIVERY_BENSON, DELIVERY_CARL, DELIVERY_DANIEL, DELIVERY_ELLE));
    }
}
